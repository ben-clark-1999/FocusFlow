...
let win = null;
// --- helpers ---
const fromURL = (u) => fileURLToPath(typeof u === 'string' ? new URL(u, import.meta.url) : u);
...
ipcMain.handle('file:read', async (_e, absPath) => {
